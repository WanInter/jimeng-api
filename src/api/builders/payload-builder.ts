...
export type RegionKey = "CN" | "US" | "HK" | "JP" | "SG" | "VN";
 ...
 * - HK/JP/SG/VN 站 nanobanana: 强制 1k 分辨率，但 ratio 可自定义
...
export function resolveResolution(
  ...
  if (userModel === "nanobanana") {
    if (regionKey === "US") {
      ...
      // HK/JP/SG/VN 站: 强制 1k 分辨率，但 ratio 可自定义
